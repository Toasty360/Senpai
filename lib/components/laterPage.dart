                                                                  ...
                                                                  child:
                                                                      GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            _meeduPlayerController.setFullScreen(true,
                                                                                context);
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            downloadData[key]![index].path.split("/").last.split('.')[0],
                                                                            style:
...
class downloadPlayer extends StatefulWidget {
  final String title;
  final File data;
  const downloadPlayer({super.key, required this.title, required this.data});

  @override
  State<downloadPlayer> createState() => _downloadPlayerState();
}
